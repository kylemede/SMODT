...
'DIdataFile': '/run/media/kmede/HOME/Dropbox/EclipseWorkspaceDB/SMODT/ExoSOFT/settings_and_inputData/Jupiter5percent_DIdata.dat',                
# full path to input radial velocity data file. [string]
'RVdataFile': '/run/media/kmede/HOME/Dropbox/EclipseWorkspaceDB/SMODT/ExoSOFT/settings_and_inputData/Jupiter5percent_RVdata.dat',
}
