...
#*************************************************************************************************************************
'outRoot' : "SMODT2-SuperEARTH-DI-5percent-retro-lowEccTrue-test",
#*************************************************************************************************************************               
# full path to input astrometry data file. [string]
'DIdataFile': '/run/media/kmede/HOME/Dropbox/EclipseWorkspaceDB/SMODT/ExoSOFT/settings_and_inputData/SuperEarth5percent_DIdata.dat',                
# full path to input radial velocity data file. [string]
'RVdataFile': '/run/media/kmede/HOME/Dropbox/EclipseWorkspaceDB/SMODT/ExoSOFT/settings_and_inputData/SuperEarth5percent_RVdata.dat',
}
...
'mass2MIN' : 0.00004,#0.00000298949193585
'mass2MAX' : 0.00009,
