...
void SimSettingsObj::settingsLoadUp(const char* filename)
{
	...
	silent = true;
	verbose = false;
	settings_and_InputDataDir = "/mnt/Data1/Todai_Work/Dropbox/workspace/Binary-project/C++Stuff/SimSettings_and_InputData/";
		...
		if (line.length()>0)
		{
			...
			if (line[0]!='#' && loc>0)
			{
				...
				else if (key.compare("CalcGelmanRubin")==0)
				{
					...
					if (CalcGelmanRubin)
						boolStr = "true";
					else if (!CalcGelmanRubin)
						boolStr = "false";

					if (verboseInternal)
						cout<<"CalcGelmanRubin: "<<boolStr<<endl;
				}
				...
				else if (key.compare("calcCorrLengths")==0)
				{
					...
					if (calcCorrLengths)
						boolStr = "true";
					else if (!calcCorrLengths)
						boolStr = "false";

					if (verboseInternal)
						cout<<"calcCorrLengths: "<<boolStr<<endl;
				}
				...
				else if (key.compare("simulate_StarStar")==0)
				{
					...
					if (simulate_StarStar)
						boolStr = "true";
					else if (!simulate_StarStar)
						boolStr = "false";

					if (verboseInternal)
						cout<<"simulate_StarStar: "<<boolStr<<endl;
				}
				else if (key.compare("simulate_StarPlanet")==0)
				{
					...
					if (simulate_StarPlanet)
						boolStr = "true";
					else if (!simulate_StarPlanet)
						boolStr = "false";

					if (verboseInternal)
						cout<<"simulate_StarPlanet: "<<boolStr<<endl;
				}
				else if (key.compare("fixed_planet_period")==0)
				{
					fixed_planet_period = boolParser(val);
					string boolStr;
					if (fixed_planet_period)
						boolStr = "true";
					else if (!fixed_planet_period)
						boolStr = "false";

					if (verboseInternal)
						cout<<"fixed_planet_period: "<<boolStr<<endl;
				}
