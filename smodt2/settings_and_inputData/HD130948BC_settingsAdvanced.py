...
'chiMaxST':(2.215,'Max reduced chiSquared to enter ST.'),
...
'nSigStps': (250,"Times to calc acceptance and tune sigmas."),
...
'paraEst' : (55.03,"Estimated parallax"),
'paraErr' : (0.34,"Estimated parallax error"),
##################################
