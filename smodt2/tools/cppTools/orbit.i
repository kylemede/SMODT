...
%apply (double* INPLACE_ARRAY1,int DIM1) {(double *y, int y_n)};
//pass in 2D array of dynamic size, that CAN change in CPP func
...
%apply (double* INPLACE_ARRAY2,int DIM1, int DIM2, double* INPLACE_ARRAY1, int DIM1) {(double *yy, int yy_nx, int yy_ny, double *y, int y_n)};
