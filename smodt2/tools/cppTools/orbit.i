...
//pass in a 2D array of dynamic size, that CAN change in CPP func, along with a 1D array that can NOT change
%apply (double* INPLACE_ARRAY2,int DIM1, int DIM2, double* IN_ARRAY1, int DIM1) {(double *yy, int yy_nx, int yy_ny, double *x, int x_n)};
